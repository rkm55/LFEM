# approximation 2.6 galerkin approx
# author: ryan melander

import numpy
import unittest
import basis2 # basis function from github
import basis  # my basis functions
import scipy
import matplotlib.pyplot as plt
from gram_matrix import assembleGramMatrix
from force_vector import assembleForceVector
...
d_test1 = numpy.array( [ (12*(numpy.pi**2 - 10))/(numpy.pi**3), -(6*(3*numpy.pi**2 - 40))/(numpy.pi**3), (12*(numpy.pi**2 - 10))/(numpy.pi**3)] )
...
if __name__ == '__main__':
    class Test_computeSolution( unittest.TestCase ):
        def test_cubic_polynomial_target( self ):
            ...
            degree = 2
            solution_basis = basis.evalBernsteinBasis1D
            solution_basis2 = basis2.evalBernsteinBasis1D
            ...
            fit_err = computeFitError( gold_sol_coeff, test_sol_coeff, domain, solution_basis2 )
            # plotCompareGoldTestSolution( gold_sol_coeff, test_sol_coeff, domain, solution_basis2 )
            # plotCompareFunToTestSolution( target_fun, test_sol_coeff, domain, solution_basis2 )
        ...
        def test_sin_target( self ):
            ...
            fit_err = computeFitError( gold_sol_coeff, test_sol_coeff, domain, solution_basis2 )
            # plotCompareGoldTestSolution( gold_sol_coeff, test_sol_coeff, [0, 1], solution_basis2 )
            # plotCompareFunToTestSolution( target_fun, test_sol_coeff, domain, solution_basis2 )
        ...
        def test_erfc_target( self ):
            ...
            fit_err = computeFitError( gold_sol_coeff, test_sol_coeff, domain, solution_basis2 )
            # plotCompareGoldTestSolution( gold_sol_coeff, test_sol_coeff, [-2, 2], solution_basis2 )
            # plotCompareFunToTestSolution( target_fun, test_sol_coeff, domain, solution_basis2 )
        ...
        def test_exptx_target( self ):
            ...
            fit_err = computeFitError( gold_sol_coeff, test_sol_coeff, domain, solution_basis2 )
            # plotCompareGoldTestSolution( gold_sol_coeff, test_sol_coeff, [-1, 1], solution_basis2 )
            # plotCompareFunToTestSolution( target_fun, test_sol_coeff, domain, solution_basis2 )
